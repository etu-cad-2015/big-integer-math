...
function gcf_nn_n(a ,b) {
  ...
  switch (com_nn_d(a, b)) {      // проверяем, какое из чисел больше, вызывая модуль com_nn_d
    ...
    case 2:                       // 2 - a > b, переходим к алгоритму Евклида
      ...
      while (1) {
        q = mod_nn_n(a, b);       // берем остаток от a / b

        if (nzer_n_b(q)) {        // проверяем остаток на равенство нулю
    ...
    default: console.log("in function gcf_nn_n: function com_nn_d has returned an incorrect value"); // если com_nn_d возвращает неверное значение,
  }                                                                                                  // выводим сообщение
}